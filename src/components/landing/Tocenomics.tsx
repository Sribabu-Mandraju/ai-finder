...
const tokenomicsData: TokenomicsItem[] = [
  { name: "Mining", percentage: "40%", image: tokenImage1 },
  { name: "Treasury", percentage: "40%", image: tokenImage2 },
  { name: "Public Sale", percentage: "40%", image: tokenImage3 },
  { name: "Seed", percentage: "40%", image: tokenImage4 },
  { name: "Contributor", percentage: "40%", image: tokenImage5 },
  { name: "Liquidity", percentage: "40%", image: tokenImage6 },
];
